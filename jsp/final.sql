...
INSERT INTO `Product` VALUE (3, '曾拌麵-胡蔴醬香(香辣醬版) (4包/袋)', 1, '198', '100', '麵體：細扁麵。\n辛辣程度：小辣。\n香辣醬內含海鮮成分。\n堅持手工日曬麵製程；健康純粹，感動美味。\n嚴選純正白芝麻粒，低溫研磨，完整保留白芝麻的香氣及營養。\n獨家秘製香辣醬，嚴選多種純天然辛香料，為香辣醬增添一股溫醇而有質感的麻與香。', 'assets/images/p3.jpg');
INSERT INTO `Product` VALUE (4, '曾拌麵-柚香冷麵 (3包/盒)', 1, '198', '100', '奶素可食。\n麵體：芯型麵。\n辛辣程度：不辣。\n堅持手工日曬麵製程；健康純粹，感動美味。\n每一口都品嚐得到柚香醬汁的清爽甘甜。', 'assets/images/p4.jpg');
INSERT INTO `Product` VALUE (5, '曾拌麵-咖哩叻沙 (4包/袋)', 1, '198', '100', '麵體：細扁麵。\n辛辣程度：中辣。\n日曬細扁麵拌進含有新鮮椰漿的咖哩叻沙中，細緻濃郁的口感融合在舌尖，溫潤帶甜、濃而不膩，每一口都吃得到屬於南洋咖哩的風味。', 'assets/images/p5.jpg');
INSERT INTO `Product` VALUE (6, '千拌麵-醋香麻醬 (3包/袋)', 2, '189', '100', '傳統石磨機研磨/黃金比例台九花生、白芝麻/天然醬料', 'assets/images/p6.jpg');
INSERT INTO `Product` VALUE (7, '千拌麵-香辣擔擔麵 (3包/袋)', 2, '189', '100', '蒜香辣籽油/香醇厚麻醬/80年功夫麵\n植物五辛素', 'assets/images/p7.jpg');
...
INSERT INTO `Product` VALUE (10, '千拌麵-香芋米粉 (3包/袋)', 2, '168', '100', '綿密芋頭 / 脆甜蔬菜 / 香酥不油膩紅蔥頭/葷食', 'assets/images/p10.jpg');
INSERT INTO `Product` VALUE (11, '賈以食日-泰式酸辣粉（3入/盒）', 3, '229', '100', '精選泰式辛香料調配而成酸辣醬\n加水即可呈現泰國TOM YUM湯頭\n純綠豆製成彈牙細寬粉吸附整個湯汁\n搭配新鮮乾燥高麗菜增添豐富口感\n撒上泰式辣椒粉提升整體香辣層次\n在家也能嚐到道地異國風味\n不論何時都能輕易地享用泰式酸辣粉', 'assets/images/p11.jpg');
INSERT INTO `Product` VALUE (12, '賈以食日-雞白湯拉麵（3份入/盒）', 3, '399', '100', '日本研發技術合作、原裝進口，傳承道地濃厚雞白湯頭\n獨家秘製金黃色澤雞油與特調辣椒粉，提升整體色香味\n堅持九道反覆延壓工序製作日式細拉麵，Q彈帶勁口感\n', 'assets/images/p12.jpg');
INSERT INTO `Product` VALUE (13, '賈以食日-雙椒麵（4入/袋）', 3, '268', '100', '大紅袍香與青花椒麻\n雙重熬製的獨特醬料\n嚴選波浪中板刀削麵\n香、麻、辣一次到位', 'assets/images/p13.jpg');
INSERT INTO `Product` VALUE (14, '賈以食日-麻花麵（4入/袋）', 3, '268', '100', '香醇研磨白芝麻醬\n採用大紅袍花椒油\n嚴選日曬手摺細麵', 'assets/images/p14.jpg');
INSERT INTO `Product` VALUE (15, '賈以食日-麻薑麵（4入/袋）', 3, '268', '100', '黑麻油與在地老薑低溫熬煮\n38度香醇料理高粱酒\n嚴選古法手摺細麵線', 'assets/images/p15.jpg');
INSERT INTO `Product` VALUE (16, '賈以食日-拌麵禮盒（9入/盒）', 3, '599', '100', '用心創作一碗麵\n麻花麵・雙椒麵・麻薑麵\n拌出家常的幸福滋味\n獻上最真摯的麵麵俱到心意', 'assets/images/p16.jpg');
INSERT INTO `Product` VALUE (17, '老媽拌麵-紅油擔擔（3入/袋）', 4, '158', '100', '老媽擔擔麵 素食口味乾拌麵\n花椒辣油與麻醬完美搭配，層層調味驚喜你的味蕾\n完美襯托麻醬的Q彈細麵，吃出古法日曬關廟麵特有的麵粉香氣', 'assets/images/p17.jpg');
INSERT INTO `Product` VALUE (18, '老媽拌麵-蒜香麻油（3入/袋）', 4, '158', '100', '老媽拌麵 x 全聯限定口味\n濃厚黑麻油香氣結合淡淡的蒜香味\n搭配滑順的麵線，在這冬天裡帶給你幸福與療癒', 'assets/images/p18.jpg');
INSERT INTO `Product` VALUE (19, '老媽拌麵-香菇炸醬（4入/袋）', 4, '185', '100', '選用台灣特產山珍香菇，五辛素可食乾拌麵\n古法手工日曬關廟麵，寬版波浪狀完美沾附醬汁', 'assets/images/p19.jpg');
INSERT INTO `Product` VALUE (20, '老媽拌麵-川味紅燒牛肉拉麵（3入/盒）', 4, '799', '100', '川味紅燒牛肉拉麵一次滿足 不用上餐廳也能享受\n嚴選澳洲穀飼牛腱心，油花分佈均勻口感軟嫩\n牛肉增量50%，就是要你吃的豪邁\n加入私房拌炒牛油 香辣口味層次再升級', 'assets/images/p20.jpg');
INSERT INTO `Product` VALUE (21, '老媽拌麵-干貝花雕雞拉麵（3入/盒）', 4, '538', '100', '美國泡麵達人里納許2022評選冠軍\n嚴選白露花老母雞熬製，不添加化學香精\n特選金華火腿搭配干貝，集合濃、醇、鮮、鹹香\n加上精釀花雕酒增添風味\n傳承古法，手工日曬手折關廟麵條', 'assets/images/p21.jpg');
