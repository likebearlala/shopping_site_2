...
%>
    ...
    <aside>
        ...
        <div class="aside-Qian">
            <a href="product_ALL-qiaoqiao.jsp">千拌麵</a>
        </div>
...
<%  
    try {
		if(con.isClosed())
            ...
            sql = "SELECT count(*) FROM product WHERE `PBrand` = '千拌麵';" ;
            ResultSet tmp = con.createStatement().executeQuery(sql);
			tmp.next();
%>
            <h2>千拌麵 </h2><h3>( <%out.println(tmp.getString("count(*)"));%>)</h3>
        </div>
<%
			sql = "SELECT * FROM product WHERE `PBrand` = '千拌麵';" ;
